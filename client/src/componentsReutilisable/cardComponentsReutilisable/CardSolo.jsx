...
export default function CardSolo({rotation,color,opacity,source,left,descriptionImg,textUn,textDeux,textTrois,textQuatre}) {
  ...
  return (
    <motion.div  style={ {transform:rotation,left:left,background:color}}  className='supp1600:w-[31%] supp1600:h-[450px] absolute  transition-transform duration-500 ease-linear w-[31%] h-[430px] rounded-[50px] text-center flex flex-col items-center justify-center'>
