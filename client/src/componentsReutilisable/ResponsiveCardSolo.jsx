...
export default function ResponsiveCardSolo({transform,background,opacity,src,alt,textUn,textDeux,textTrois,textQuatre}) {
  return (
    <motion.div  style={ {transform:transform,background:background}} className="supp480:h-[450px] supp480:w-[400px] supp768:h-[550px] supp768:m-[30px] supp768:w-[450px] supp1024:w-[530px] left-auto transition-transform duration-500 ease-linear  relative h-[320px] m-[10px] rounded-[50px] text-center w-[250px] flex flex-col items-center justify-center">
