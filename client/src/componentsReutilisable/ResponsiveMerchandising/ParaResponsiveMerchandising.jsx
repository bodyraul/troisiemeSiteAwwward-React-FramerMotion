...
export default function ParaResponsiveMerchandising({nb}) {
    ...
    return(
        <div style={{boxShadow:`rgba(100, 100, 111, 0.2) 0px 7px 29px 0px`}} className='supp480:w-[400px] supp480:mb-[40px] supp768:w-[600px] supp768:mb-[50px] supp1024:w-[80%] supp1024:mb-[70px]  flex flex-col items-center justify-center w-[250px] bg-blanc rounded-[40px] mb-[30px] '>
