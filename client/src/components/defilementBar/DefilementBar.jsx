...
export default function DefilementBar() {
  ...
  return (
    <div ref={bar} className=' supp480:w-[460px] supp480:h-[65px] supp768:w-[600px] supp768:h-[80px] supp1024:w-[100%] supp1024:h-[100px] supp1600:h-[10vh] translate-y-1/2 transition-transform duration-[400] delay-700 ease-out w-[250px] h-[50px] flex flex-row items-center justify-center '>
        <div className='supp1024:w-4/5 supp1600:h-[70%] w-[90%] max-w-[1800px] h-full bg-noir rounded-[30px] relative overflow-hidden'>
