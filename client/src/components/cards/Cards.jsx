    ...
    return (
      <div  ref={englobeCardTitre}  className='h-[1200px] w-full flex flex-col items-center justify-center relative '>
        ...
        <div  className="w-[80%] max-w-[1800px] h-[500px] mb-[10px] relative ">
          ...
          <CardSolo rotation={rotationCardDeux} opacity={"0.6"} color={"#2b2b2b"}  source={imgFleche} left={"35%"} descriptionImg={descriptionImg[1]} textUn={textUn[1]} textDeux={textDeux[1]} textTrois={textTrois[1]} textQuatre={textQuatre[1]}></CardSolo>
          <CardSolo rotation={rotationCardTrois} opacity={"0.7"} color={"#363636"}  source={carrer} left={"69%"} descriptionImg={descriptionImg[2]} textUn={textUn[2]} textDeux={textDeux[2]} textTrois={textTrois[2]} textQuatre={textQuatre[2]}></CardSolo>
        </div>
      </div>
    )
